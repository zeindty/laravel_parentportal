                    ...
                    <div class="mx-auto py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" 
                                :value="old('name', $child->name)" required autofocus autocomplete="name" />
                        ...
                        <div>
                            ...
                            <x-text-input id="gender" class="block mt-1 w-full" type="text" name="gender" 
                                :value="old('gender', $child->gender)" required autofocus autocomplete="gender" />
                        ...
                        <div>
                            ...
                            <x-text-input id="age" class="block mt-1 w-full" type="number" name="age" 
                                :value="old('age', $child->age)" required autofocus autocomplete="age" />
                        ...
                        <div>
                            ...
                            <x-text-input id="birth" class="block mt-1 w-full" type="date" name="birth" 
                                :value="old('birth', $child->birth)" required autofocus autocomplete="birth" />
                        ...
                        <div>
                            ...
                            <x-text-input id="parent" class="block mt-1 w-full" type="text" name="parent" 
                                :value="old('parent', $child->parent)" required autofocus autocomplete="parent" />
                        ...
                        <div>
                            ...
                            <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" 
                                :value="old('address', $child->address)" required autofocus autocomplete="address" />
